<?php
$templateFile = 'managebusinesslist.tpl.html';
...
if($kw) {
	$condition .= " AND (`nameBusiness` LIKE '%$kw%' OR `codoBusiness` LIKE '%$kw%')";
...
$url = '/'.ADMIN_SCRIPT."?op=manage&act=business&mod=list&doo=$action&kw=".urlencode($kw)."&ipp=$items_per_page&pg=%d";
$urls = new Url();
