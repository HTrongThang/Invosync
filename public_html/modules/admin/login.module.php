...
// KIỂM TRA SESSION ĐĂNG NHẬP CŨ: Nếu đã đăng nhập trước đó, chuyển thẳng vào trang quản trị
if (isset($_SESSION['userId']) && $_SESSION['userId'] != 0) {
	$script = (basename($_SERVER['SCRIPT_NAME']) == 'admincp.php') ? ADMINCP_SCRIPT : ADMIN_SCRIPT;
	header("location: " . $script . "?op=manage");
	exit;
} else {
