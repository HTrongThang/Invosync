...
$sitemap_file = "sitemap_article.xml";
# Priotity settings
$week_prio = 0.5;
$item_prio = 0.3;
$cat_prio = 0.8;
...
$listArticle = $articles->getObjects(1, "a.status = '1'", array("a.id" => "ASC"), 9999);
...
if ($listArticle) {
    foreach ($listArticle as $key => $value) {
        ...
        $Namearticles = removeSpecialCharsVn($value->getTitle());
        ...
        $content .= print_xml($article, $priority, $lastmod, $item_update, $img, $Namearticles, $Namearticles);
    }
}
